from interaction_manual import manual_enemy_encounter, manual_in_battle, manual_post_battle
from interaction_automatic import auto_enemy_encounter, auto_in_battle, auto_post_battle
