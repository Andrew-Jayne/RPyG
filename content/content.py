...
def load_content_files(dir_path: str) -> dict:
    ...
    :return: A dictionary containing all merged content from the JSON files.
    """
    combined_content = {}
            ...
            if file_name.endswith('.json'):
                ...
                with open(file_path, 'r') as file:
                    ...
                    if not isinstance(content_object, dict):
                        raise ValueError(f"The file {file_path} does not contain a valid JSON object.")
...
ENEMIES_STANDARD = load_content_files(ENEMIES_STANDARD_PATH)
