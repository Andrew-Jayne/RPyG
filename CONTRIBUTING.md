...
This project is built with the intention of running on any Python environment. As such, the use of non-standard packages is not allowed; this unfortunately includes UI libraries like Turtle, Curses, or Tkinter (which are in the standard library, but do not come with default install on most platforms, and also require platform specific configurations). This is an intentional part of the project design and goals.

## Roadmap

There is not an official roadmap but the general planning and ideas for progress are kept in `todo.md`
...
See [CODING_STANDARDS.md](./_docs&plans/CODING_STANDARDS.md)


## AI Addendum
I know that AI makes coding trivial, and that claude code can make this project from a single prompt.

But this is a fun personal project, and much in vein of someone selling handmade mugs on Etsy for $15 in 2012 I'm doing this because I want to, and because it's fun.
