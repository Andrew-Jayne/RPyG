...
class Combat:
    ...
    def battle(player_party_instance: PlayerParty, enemy_party_instance: EnemyParty) -> bool:
        ...
        while __class__.battle_complete is False:
            ...
            if __class__.is_battle_complete(player_party_instance,enemy_party_instance) is False:
        ...
        if __class__.is_party_alive(player_party_instance) is True and __class__.is_party_alive(enemy_party_instance) is False and __class__.battle_complete is True:
